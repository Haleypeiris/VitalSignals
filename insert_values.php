...
if(isset($_GET["yAcc"])) {
   ...
   $patient_id = 1;
   //$sql = "INSERT INTO acceleration (patient_id, y_acc, x_acc, z_acc, time_stamp, acc_array) VALUES ($patient_id, $yAcc, $rr, 1290.00, NOW(), $yAccString)";
   ...
   if (mysqli_query($db,$sql) === TRUE) { //aka if true
